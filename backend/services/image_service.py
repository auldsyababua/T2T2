...
class ImageService:
    def __init__(self, s3_bucket: str, aws_access_key_id: str, aws_secret_access_key: str):
        ...
        self.clip_model, self.preprocess, _ = create_model_and_transforms('ViT-B-32', pretrained='openai')

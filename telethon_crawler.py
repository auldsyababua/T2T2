...
class TelethonCrawler:
    ...
    async def crawl_chat(self, chat_id: int, limit: int = 1000, 
                        min_date: Optional[datetime] = None,
                        max_date: Optional[datetime] = None) -> List[Dict]:
    ...
    async def _extract_media_info(self, message: Message) -> Dict:
        ...
        try:
            if hasattr(message.media, 'photo'):
                ...
                media_info['file_size'] = message.media.photo.sizes[-1].size if message.media.photo.sizes else None
    ...
    async def download_media(self, message: Message, download_path: str = "./downloads") -> Optional[str]:
